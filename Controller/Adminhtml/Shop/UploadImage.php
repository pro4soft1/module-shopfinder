 ...
 * Class UploadImage
 *
 * @package \Sf\Shopfinder\Controller\Adminhtml\Shop
 */
class UploadImage extends \Magento\Backend\App\Action
{
    ...
    {
        $imageUploadId = $this->getRequest()->getParam('param_name','general[image]');
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'shop/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'shop/' . $firstName . '/' . $secondName . '/';
          ...
          $move =   $this->fileIo->mv($basePath . $imageName, $mediaRootDir . $newImageName);
